...
function Unprotect-Bruteforce {
    ...
    begin {
        ...
        $PathToModule = Split-Path (Get-Module -ListAvailable Unprotect-Bruteforce).path
    ...
    process {
        ...
        if ($RDP) {
            ...
            if ($PSCmdlet.ShouldProcess($Verb, $BlockList.IpAddress, 'Unprotect-Bruteforce')) {
                Write-Verbose $Verb
...
#Example usage: 
#Unprotect-Bruteforce -RDP -Verbose